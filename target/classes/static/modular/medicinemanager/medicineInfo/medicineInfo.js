...
MedicineInfo.initColumn = function () {
    return [
        {field: 'selectItem', radio: true},
            {title: '意见内容编号', field: 'id', visible: true, align: 'center', valign: 'middle'},
            {title: '主题', field: 'medicineName', visible: true, align: 'center', valign: 'middle'},
            {title: '需求', field: 'medicinePrice', visible: true, align: 'center', valign: 'middle'},
            {title: '内容', field: 'medicineValue', visible: true, align: 'center', valign: 'middle'}
    ];
};
