...
Info.initColumn = function () {
    return [
        {field: 'selectItem', radio: true},
            {title: '', field: 'paientIdcard', visible: true, align: 'center', valign: 'middle'},
            {title: '', field: 'paientName', visible: true, align: 'center', valign: 'middle'},
            {title: '', field: 'paientMoney', visible: true, align: 'center', valign: 'middle'}
    ];
};
