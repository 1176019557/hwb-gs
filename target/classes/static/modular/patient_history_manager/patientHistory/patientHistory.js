...
PatientHistory.initColumn = function () {
    return [
        {field: 'selectItem', radio: true},
            ...
            {title: '所提问题', field: 'patientSym', visible: true, align: 'center', valign: 'middle'},
            {title: '接待人员', field: 'patientDoctor', visible: true, align: 'center', valign: 'middle'},
            {title: '接待方式', field: 'patientMedicine', visible: true, align: 'center', valign: 'middle'},
            {title: '接待日期', field: 'patientHistoryDate', visible: true, align: 'center', valign: 'middle'},
            {title: '预计花费时间', field: 'takeprice', visible: true, align: 'center', valign: 'middle'}
    ];
};
